...
public class yuzidialog : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        else//第一次之后触发日常对话
        {
            ...
            textLabel.text = "小伙子你又变强啦！要来给你的武器进行一次强化嘛？50金币一次，攻击力可以+3！";
            box.SetActive(true);
        }
    ...
    void ClickEvent2(int a)
    {
        ...
        switch (buttons[a].name)
        {
            case "strengthen"://这里可以让该类继承player然后修改他的金币数和攻击力
                ...
                {
                    //Debug.Log("buy");
                    textLabel.text = "收您50金币！这是强化后的武器，请拿好！";
                    isbox = true;
                    PlayerController.coinNum -= 50;
                    PlayerController.defendNum += 3;
                }
                else
                {
